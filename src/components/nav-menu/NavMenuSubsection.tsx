 ...
 */
const NavMenuSubsection: FC<Props> = ({ children, title, isVisible, onHeaderClick }) => {
  ...
  return (
    <>
      <div className={styles.title} onClick={onClick} onKeyDown={onEnter} role="button" tabIndex={0}>
        {title}
      </div>
